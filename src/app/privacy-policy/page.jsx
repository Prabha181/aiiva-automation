...
<p className="mb-6">
  If you choose to provide AIIVA Automation with a third party’s personal information (such as name, email, and phone number), you represent that you have the third party’s permission to do so. Examples include forwarding reference or marketing material to a friend or sending job referrals. Third parties may unsubscribe from any future communication following the link provided in the initial message. In some instances, AIIVA Automation and the third parties we engage may automatically collect data through cookies, web logs, web beacons, and other similar applications. This information is used to better understand and improve the usability, performance, and effectiveness of the website and to help tailor content or offers for you.
</p>
...
<p className="mb-6">
  Operating our business, delivering, improving, and customizing our websites, mobile applications and Solutions
  Sending marketing and other communications related to our business, and for other legitimate purposes permitted by applicable law.
  ...
  Sending communications to you, including for marketing or customer satisfaction purposes, either directly from AIIVA Automation or from our partners.
</p>
...
<p className="mb-6">
  In general, AIIVA Automation may use your Registration Data and/or other information or data we receive or collect, as well as data we derive or infer from combinations of the foregoing, for a variety of purposes, such as:
</p>

<p className="mb-6">
  To facilitate the creation of and secure your account on the Service.
  To customize and personalize the advertising and other content we deliver to you both on the Service and via partners. We use this information to provide you with relevant and interesting advertising and other content.
  To measure and analyze Service usage and enhance the user experience on our Service. This helps us continue to build a better Service for you.
  To send you information that you agreed to receive.
  To pay third party fees for the content you see in the app.
</p>
...
<p className="mb-6">
  ...
  Some AIIVA Automation entities may act as or be considered “data controllers”. When an AIIVA Automation entity is acting as a data controller, you can exercise your rights of access and request corrections, suppression, or deactivations under applicable data protection laws directly with that AIIVA Automation entity by writing to support@aiivaautomation.com.
...
<p className="mb-6">
  ...
  By sending us a message through email or by mail to: AIIVA AUTOMATION PRIVATE LIMITED Plot No.102, Survey No, 41 & 42, Kavuri Hills Phase 1, beside line of Jubilee Ridge Hotel, Guttala_Begumpet, Madhapur, Telangana, 500033
</p>
...
<p className="mb-6">
  ...
  Within AIIVA Automation and its parent companies or subsidiaries for purposes of data processing or storage.
  With AIIVA Automation business partners or vendors, so that they may share information with you about their products or services. To opt-out of AIIVA Automation sharing with third parties for their marketing purposes, click here.
  ...
  With law enforcement officials, government authorities, or other third parties as necessary to comply with legal process or meet national security requirements.
  In aggregated and/or anonymised form which cannot reasonably be used to identify you.
...
<p className="mb-6">
  We intend to protect the personal information entrusted to us and treat it securely in accordance with this Privacy Statement. AIIVA Automation implements physical, administrative, and technical safeguards designed to protect your personal information from unauthorized access, use, or disclosure. We also contractually require that our suppliers protect such information from unauthorized access, use, and disclosure. The Internet, however, cannot be guaranteed to be 100% secure, and we cannot ensure or warrant the security of any personal information you provide to us.
</p>
...
<p className="mb-6">
  Like many websites, AIIVA Automation uses automatic data collection tools, such as cookies, embedded web links, and web beacons. These tools collect certain standard information that your browser sends to our website.
</p>

<p className="mb-6">
  Your Internet Protocol (IP) address. This is a number automatically assigned to your computer or device whenever you connect to the Internet. It is a unique address assigned by your Internet service provider or IT department on a TCP/IP network.
</p>

<p className="mb-6">
  Click stream behavior. This includes the pages you view and the links you click. These tools help improve experience and performance.
</p>

<p className="mb-6">
  Some web browsers may give you a “do not track” feature. AIIVA Automation websites do not currently respond to “do not track” signals.
</p>
...
<p className="mb-6">
  If you participate in discussion forums or chat rooms on an AIIVA Automation website, your information may be publicly visible.
</p>
...
<p className="mb-6">
  AIIVA Automation does not knowingly collect personal information from children without appropriate parental consent.
</p>
...
<p className="mb-6">
  Should you have questions or comments related to this Privacy Statement, please email support@aiivaautomation.com.
</p>

<p className="mb-6">
  AIIVA AUTOMATION PRIVATE LIMITED, Plot No.102, Survey No, 41 & 42, Kavuri Hills Phase 1, Madhapur, Telangana, 500033
</p>
...
<p className="mb-6">
  We may update this Privacy Statement from time to time. If we modify our Privacy Statement, we will post the revised version here.
</p>
